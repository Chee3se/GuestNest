...
export default function EditPropertyForm({ onClose, show, property }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('property.update', property.id))
            .then(() => {
                if (onClose) {
                    onClose();
                }
    ...
    return (
        <Modal onClose={onClose} show={show}>
            <p className="font-medium text-6xl p-4 text-center dark:text-amber-50">Edit Property</p>
